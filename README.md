...
This dataset provides time series of 2D grid maps for path planning. These indicate pedestrians' distribution in dense crowds and are generated by the proposed pedestrians' trajectory prediction method.

Download the dataset (data.airc.aist.go.jp/dense_crowds_dataset/50pedestrians_50scenes.tar.xz) and (data.airc.aist.go.jp/dense_crowds_dataset/50pedestrians_50scenes_true_trajectory.tar.xz)
- Number of scenes : 50
